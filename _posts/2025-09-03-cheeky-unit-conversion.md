...
The above approach works well in Python and you _probably_ don't need to install another package as chances are `ase` has been installed as needed by your materials science work!

However, what if I want to use other units than `eV` for energy? Of course, I can convert it _to_ eV and then to others....
...
To convert units, one can use the `uconvert` function with the first arguments being the _unit to be converted to_:
